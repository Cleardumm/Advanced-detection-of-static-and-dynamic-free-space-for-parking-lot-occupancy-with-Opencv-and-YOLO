...
while (cap.isOpened()):
    ...
    if ret == True:
        ...
        for i in range(len(freespacerange)):
            ...
            cv.putText(frame, "Parking space from"+"52.51303"+","+str(round(x_left,5))+"to"+"52.51303"+","+str(round(x_right,5)) + " engouh for " + str(motor) + " Motorcycle " + str(car)+ " Car", (0, 580 +i*10), cv.FONT_HERSHEY_SIMPLEX, 0.4,
                        (0, 255, 255), 1)

            ##Set the location of free parking space in the middle manually .
            #draw the freespace
            frame[285:305, range_left:range_right,1] = 255
            frame[285:305, range_left:range_right, 0] = 0
            frame[285:305, range_left:range_right, 2] = 0
    ...
    # Drawing a circle around corners
        ...
        outdynamic=[]
        for i in range(len(freespacerange)):#make the dynamic parking area information list of logfile
            range_left = freespacerange[i][0]
            range_right = freespacerange[i][1]
            x_left=(13.32754-13.32859)/1280*(range_left-0)+13.32859
            x_right=(13.32754-13.32859)/1280*(range_right-0)+13.32859
        ...
        if frequency1 == 200:#write out the logfile
